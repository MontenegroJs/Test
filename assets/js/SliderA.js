function Changesectioncontent1() {
	document.getElementById("Sectioncontent1").innerHTML = "Mesa de partes virtual"
	...
	$('#B1').prop('href','administración/MVP.html');
	$('#B2').prop('href','administración/DD.html');
	$('#B3').prop('href','administración/MVP.html');
	$('#B4').prop('href','administración/MVP.html');
	$('#B5').prop('href','administración/MVP.html');
	$('#B6').prop('href','administración/MVP.html');
	$('#B7').prop('href','administración/MVP.html');
	$('#B8').prop('href','administración/MVP.html');
}
...
function Changesectioncontent2() {
	...
	$('#B1').prop('href','administración/MVP.html');
	$('#B2').prop('href','administración/MVP.html');
	$('#B3').prop('href','administración/MVP.html');
	$('#B4').prop('href','');
	$('#B5').prop('href','');
	$('#B6').prop('href','');
